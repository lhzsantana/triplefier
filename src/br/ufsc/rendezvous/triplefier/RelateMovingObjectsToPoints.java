...
public class RelateMovingObjectsToPoints {

    private static final String _FILE = "data/mo_stm.csv";

    public static List<Triple> relateMovingObjectsToPoints(boolean verbose){
        ...
        for(String line:lines){
            ...
            Resource subject = Indexer.getSubjectFromSPO(
                    ...
                    ModelConstants.MOVING_OBJECT);
            t.setSubject(subject);

            Resource predicate = new Resource();
            predicate.setLabel(ModelConstants.OWNS.toString());
